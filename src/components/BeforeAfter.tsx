  ...
  return (
    <section id="cases" className="py-16 md:py-24 relative overflow-hidden">
      ...
      <style>{`
        ...
        /* ===== Unused legacy dash styles preserved for reference ===== */
        .dash-mockup-LEGACY {
          background: #0E1118;
          border: 1px solid rgba(255, 255, 255, 0.10);
          border-radius: 14px;
        ...
        .dash-mockup--after {
          ...
          box-shadow: 0 0 0 1px rgba(52, 211, 153, 0.05), 0 12px 30px -15px rgba(52, 211, 153, 0.18);
        }
        ...
        .dash-titlebar {
          ...
          gap: 12px;
          padding: 10px 14px;
          background: linear-gradient(180deg, #181D29, #141926);
        ...
        @media (min-width: 768px) {
          .dash-body { padding: 20px; gap: 16px; }
        }
        ...
        .dash-mockup--after .dash-hero-value {
        ...
        @media (min-width: 768px) {
          .dash-cell-value { font-size: 18px; }
        }
        .dash-cell-unit {
          font-size: 0.7em;
