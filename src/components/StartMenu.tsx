...
const START_MENU_OPTIONS: StartMenuOption[] = [
  ...
  },
  {
    ...
    subtitle: 'Залей XLS — AI Авитолог найдёт где теряются заявки',
  ...
  },
  {
    ...
    subtitle: 'AI Авитолог найдёт точки роста без слива бюджета',
  ...
  return (
    <div className={`w-full max-w-2xl mx-auto px-4 py-8 ${className}`}>
      ...
      <div className="mt-6 text-center text-xs text-muted-foreground">
        💰 Ответ AI Авитолога — 5 ₽ · Парсер конкурентов — 190 ₽ · Анализ статистики — 50 ₽
      </div>
    </div>
  );
}
