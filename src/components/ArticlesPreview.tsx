...
const PLACEHOLDER_ARTICLES: Article[] = [
  {
    ...
    excerpt: 'Разбираем алгоритм ранжирования и стратегии платного продвижения, которые реально работают.',
    readMinutes: 7,
    publishedAt: '20 мая',
  },
  {
    ...
    excerpt: 'Пошаговый чек-лист: фото, заголовки, цены, продвижение — как найти слабые места конкурентов в нише.',
    readMinutes: 10,
    publishedAt: '12 мая',
  },
  {
