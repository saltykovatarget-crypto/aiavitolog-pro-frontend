...
const faqs = [
  {
    ...
    a: 'Пополняешь кошелёк один раз — от 100 ₽ или выгодным пакетом (от 390 ₽ за 500 ₽ на кошельке). Дальше деньги списываются автоматически с каждого действия: ответ AI Авитолога — 5 ₽, парсер конкурентов — 190 ₽, анализ статистики кабинета — 50 ₽. Никаких подписок и автосписаний.',
  },
  {
    q: 'Сколько стоит попробовать?',
    a: 'Регистрация бесплатна — после неё мы зачисляем 50 ₽ бонусом на твой кошелёк. Этого хватит на 10 ответов AI, чтобы попробовать сервис без вложений.',
  },
  {
  ...
  },
  {
    ...
    a: 'Сервис не угадывает и не «делает всё сам». Он анализирует информацию, которую ты предоставляешь: нишу, регион, конкурентов, тексты, статистику, скриншоты. На основе этих данных AI Авитолог помогает принимать более точные решения и ведёт по 10 шагам методологии.',
  },
  {
