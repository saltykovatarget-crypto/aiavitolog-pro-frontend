...
const faqs = [
  {
    ...
    a: 'Пополняешь кошелёк один раз — от 100 ₽ или выгодным пакетом (от 390 ₽ за 500 ₽ на кошельке). Дальше деньги списываются автоматически с каждого действия: ответ AI — 5 ₽, парсер конкурентов — 190 ₽, анализ статистики кабинета — 50 ₽. Никаких подписок и автосписаний.',
  },
  {
  ...
  },
  {
    ...
    a: 'Сервис не угадывает и не «делает всё сам». Он анализирует информацию, которую ты предоставляешь: нишу, регион, конкурентов, тексты, статистику, скриншоты. На основе этих данных AI помогает принимать более точные решения и ведёт по 10 шагам методологии.',
  },
  {
