...
interface ChatBasicHeaderProps {
  isDark: boolean;
...
export function ChatBasicHeader({
  isDark,
  setIsDark,
  onNavigateToChat,
  onToggleSidebar,
    ...
    <header className="sticky top-0 z-50 w-full border-b bg-card/80 backdrop-blur-[10px] h-16">
      <div className="container max-w-[1280px] mx-auto px-5 h-full flex items-center justify-between">
            ...
            >
              <div className="px-3 py-2 border-b border-border">
                <div className="flex items-center gap-2 mb-1">
                  <Badge 
                    variant="secondary" 
                    className="bg-muted/20 border border-border text-muted-foreground gap-1 px-2 py-1 text-xs"
                  >
                ...
                <p className="text-sm text-muted-foreground">
                  Basic активирован до 18.09.2026
                </p>
              </div>
              <DropdownMenuItem 
        ...
        <div className="flex items-center gap-3 absolute left-1/2 transform -translate-x-1/2">
          ...
          <Badge 
            variant="secondary" 
            className="bg-muted/20 border border-border text-muted-foreground gap-1 px-2 py-1"
          >
            <Crown className="w-3 h-3" />
            Basic
          </Badge>
